...
**_  
\*Note, the current version of Parity Signer no longer supports Ethereum accounts._**

**_**Please keep in mind that this is still a beta release; it has not yet completed a full audit. You could potentially lose your keys if you do not make appropriate backups; the safety of funds cannot be guaranteed._**