...
date_published: 2021-10-13T18:00:00.000+02:00
...
Substrate connect provides a [PolkadotJS API](https://www.npmjs.com/package/@substrate/connect) connected to a bundled node, running on an actual Substrate-compatible node in JavaScript. Please note that this API is likely to change a bit going forward:
