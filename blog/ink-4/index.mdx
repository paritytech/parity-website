...
Our [new format](https://use.ink/metadata/) comes with proper documentation and formal specification. You can find the documentation of the new format [here](https://use.ink/4.0.0-alpha.1/metadata). The formal specification is available as a JSON schema [here](https://github.com/paritytech/ink/tree/master/crates/metadata). The formal schema can be used by block explorers to verify contract metadata that is uploaded by users.
...
We have written a migration guide from ink! 3.x to 4.0. You can find it on our documentation portal [here](https://use.ink/metadata/).
