...
---
# How we created 50K NFTs for Polkadot Decoded 2022 (in one month)
...
This is how he got to pixel art — a fun stylisation that suited all the NFT project requirements.
...
![](/images/image12.png)![](/images/image22.png)![](/images/image2-2.png)![](/images/image18.png)
...
![](/images/image3-2.png)![](/images/image4-1.png)
...
> 💡 Good to knowThe Uniques pallet intends to provide the core NFT functionality out of the box and lets everyone create their own NFT collection. In the next version of the pallet, “Uniques V2”, more core functionality will be added. The intention is to keep the core functionality in the pallet, which can be extended by community parachains for more customized use cases, such as composable NFTs and gaming. Learn about NFT parachains. 
...
**Step 3. Mint all NFTs**Using the uniques.mint call, it’s time to finally mint all NFTs. During minting, each item will be assigned to an address. When the NFT secret codes are claimed, the claim app will check whether the corresponding address derives from that secret code and transfer all the NFTs and assets. The claim app either lets the recipient create a new account through the app or select an existing account from someone’s [Polkadot-JS Extension](https://polkadot.js.org/extension/) or [Parity Signer](https://www.parity.io/technologies/signer/) wallet.
...
![](/images/image13.png)![](/images/image5.png)![](/images/image8.png)![](/images/image19.png)![](/images/image9.png)