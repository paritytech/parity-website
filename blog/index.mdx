...
Klaytn is a modular, open-source public blockchain for both retail and enterprise use-cases, developed by internet giant Kakao Corp and originating as an Ethereum hard fork. Klaytn’s mission is to bring business services to the blockchain, and its pursuit of key strategic partners led to this collaboration with Parity. Klaytn aims to be the blockchain of choice for gaming and metaverse projects worldwide, while continuing to pursue its established integration with DeFi. Parity and Substrate are perfectly positioned to help Klaytn explore the possibilities of a true multi-chain environment and achieve these goals.
